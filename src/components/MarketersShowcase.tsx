    ...
    <section className="py-12 bg-gradient-to-r from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform -rotate-1 mb-6">
              ...
              <div className="p-6">
                ...
                <div className="relative">
                  <img 
                    src={sortedMarketers[0].mediaUrl} 
                    alt={sortedMarketers[0].name} 
                    className="w-full h-48 object-cover mb-4 rounded-md"
                  />
                  {sortedMarketers[0].specialOffer && (
                    <div className="absolute top-2 right-2 bg-red-600 text-white px-3 py-1 rounded-full text-sm font-bold transform rotate-6">
                      {sortedMarketers[0].specialOffer}
                    </div>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 gap-2 mb-4 border-t border-gray-100 pt-4">
                  ...
                  {sortedMarketers[0].email && (
                    <a href={`mailto:${sortedMarketers[0].email}`} className="flex items-center text-engineering-600 hover:text-engineering-800">
                      <Mail size={18} className="mr-2" />
                      <span>{sortedMarketers[0].email}</span>
                    </a>
                  )}
                  {sortedMarketers[0].website && (
                    <a href={`https://${sortedMarketers[0].website}`} target="_blank" rel="noopener noreferrer" className="flex items-center text-engineering-600 hover:text-engineering-800">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform rotate-1 mt-6">
              ...
              <div className="p-6">
                ...
                <div className="relative">
                  <img 
                    src={sortedMarketers[2].mediaUrl} 
                    alt={sortedMarketers[2].name} 
                    className="w-full h-48 object-cover mb-4 rounded-md"
                  />
                ...
                <div className="grid grid-cols-1 gap-2 mb-4 border-t border-gray-100 pt-4">
                  ...
                  {sortedMarketers[2].email && (
                    <a href={`mailto:${sortedMarketers[2].email}`} className="flex items-center text-engineering-600 hover:text-engineering-800">
                      <Mail size={18} className="mr-2" />
                      <span>{sortedMarketers[2].email}</span>
                    </a>
                  )}
                  {sortedMarketers[2].website && (
                    <a href={`https://${sortedMarketers[2].website}`} target="_blank" rel="noopener noreferrer" className="flex items-center text-engineering-600 hover:text-engineering-800">
                      <Globe size={18} className="mr-2" />
          ...
          <div className="lg:w-1/2">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform rotate-1 mb-6">
              ...
              <div className="p-6">
                ...
                <div className="relative">
                  <img 
                    src={sortedMarketers[1].mediaUrl} 
                    alt={sortedMarketers[1].name} 
                    className="w-full h-48 object-cover mb-4 rounded-md"
                  />
                ...
                <div className="grid grid-cols-1 gap-2 mb-4 border-t border-gray-100 pt-4">
                  ...
                  {sortedMarketers[1].email && (
                    <a href={`mailto:${sortedMarketers[1].email}`} className="flex items-center text-engineering-600 hover:text-engineering-800">
                      <Mail size={18} className="mr-2" />
                      <span>{sortedMarketers[1].email}</span>
                    </a>
                  )}
                  {sortedMarketers[1].website && (
                    <a href={`https://${sortedMarketers[1].website}`} target="_blank" rel="noopener noreferrer" className="flex items-center text-engineering-600 hover:text-engineering-800">
                      <Globe size={18} className="mr-2" />
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden transform -rotate-1 mt-6">
              ...
              <div className="p-6">
                ...
                <div className="relative">
                  <img 
                    src={sortedMarketers[3].mediaUrl} 
                    alt={sortedMarketers[3].name} 
                    className="w-full h-48 object-cover mb-4 rounded-md"
                  />
                ...
                <div className="grid grid-cols-1 gap-2 mb-4 border-t border-gray-100 pt-4">
                  ...
                  {sortedMarketers[3].email && (
                    <a href={`mailto:${sortedMarketers[3].email}`} className="flex items-center text-engineering-600 hover:text-engineering-800">
                      <Mail size={18} className="mr-2" />
                      <span>{sortedMarketers[3].email}</span>
                    </a>
                  )}
                  {sortedMarketers[3].website && (
                    <a href={`https://${sortedMarketers[3].website}`} target="_blank" rel="noopener noreferrer" className="flex items-center text-engineering-600 hover:text-engineering-800">
                      <Globe size={18} className="mr-2" />
        ...
        <div className="text-center mt-8">
          <Button variant="outline" className="text-engineering-600 border-engineering-600 hover:bg-engineering-50">
