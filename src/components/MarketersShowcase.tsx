      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            return <Card key={marketer.id} className="overflow-hidden border-2 border-yellow-400 shadow-lg">
                  <div className="relative h-64">
                    {marketer.mediaUrl && marketer.mediaUrl.endsWith('.mp4') ? <video src={marketer.mediaUrl} className="w-full h-full object-cover" autoPlay muted loop /> : <img src={marketer.mediaUrl} alt={marketer.name} className="w-full h-full object-cover" />}
                  ...
                  <CardContent className="p-4">
                    ...
                    {marketer.industry && <Badge variant="outline" className="mb-3">
                        {marketer.industry}
                      </Badge>}
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            const typeDetails = getTypeDetails(marketer.type);
            return <Card key={marketer.id} className="overflow-hidden border border-blue-300">
                  ...
                  <CardContent className="p-4">
                    ...
                    {marketer.industry && <Badge variant="outline" className="mb-2">
                        {marketer.industry}
                      </Badge>}
        ...
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
            ...
            const typeDetails = getTypeDetails(marketer.type);
            return <Card key={marketer.id} className="overflow-hidden">
                  <CardContent className="p-3">
                    ...
                    {marketer.industry && <span className="text-xs text-gray-500 mt-1 block">
                        {marketer.industry}
                      </span>}
                  </CardContent>
                </Card>;
